    ...
    <>
        ...
        <div className='container p-2'>
            ...
            <div className="grid-container grid-cols-4 border " >
                ...
                <div className="h-24 border">
                    <div className="grid h-full text-center w-full items-center">
                        <div className="font-bold" style={{ fontSize: "15pt" }}>La Coipa</div>                              
                    </div>
                </div>
                <div className="h-24 border">
                ...
                <div className="h-24 border ">
                    <div className="grid grid-rows-4 h-full " style={{ fontSize: "9pt" }}>
                        <div className="flex " >
                            <div className="bg-primaryColorKinRoss text-white w-36 border-b border-black border-r ">Codigo</div>
                            <div className='mx-auto'>F-PE-020-CH01</div>
                        </div>
                        <div className="flex " >
                            <div className="bg-primaryColorKinRoss text-white w-36 border-b border-black border-r">Elaborado/Aprobado</div>
                            <div className='mx-auto'>P.Aguilera/S.Pereira </div>
                        </div>
                        <div className="flex">
                            <div className="bg-primaryColorKinRoss text-white w-36 border-b border-black border-r">Fecha de Emision</div>
                            <div className='mx-auto'>22/05/2019</div>
                        </div>
                        <div className="flex">
                            <div className="bg-primaryColorKinRoss text-white w-36 border-black border-r">Pagina</div>
            ...
            <table className='w-full mt-3' style={{ fontSize: "9pt" }}>
                <thead>                
                    <tr className=''>
                        <th className='border border-black w-2/12 bg-primaryColorKinRoss text-white'>GERENCIA</th>
                        <th className='border w-2/12'>  </th>
                        <th className='border border-black w-2/12 bg-primaryColorKinRoss text-white'>EMPRESA</th>
                        <th className='border w-2/12'> {encabezado.lugarFaena} </th>
                        <th className='border border-black w-2/12 bg-primaryColorKinRoss text-white'>KILOMETRAJE</th>
            ...
            Cualquier desperfecto y/o elemento o accesorio en mal estado, debe ser reportado inmediatamente a la Supervisión. <br/>
            La Supervisión debe tomar accion inmediata y si se trata de un buen critico que se encuentra en mal estado, el vehiculo debe quedar fuera de servicios hasta  su reparación
            </div> 
