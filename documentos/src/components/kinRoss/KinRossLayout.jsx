          ...
          <div className="grid-container grid-cols-4 border ">
            ...
            <div className="h-24 border">
              <div className="grid grid-rows-1 h-full text-center w-full items-center">
                ...
                <h1 className="font-bold" style={{ fontSize: "15pt" }}>
                  {" "}
            ...
            <div className="h-24 border ">
              ...
              >
                <div className="flex ">
                  ...
                  <div className="mx-auto">{dataAux.correlativo}</div>
                </div>
                <div className="flex ">
                  <div className="bg-primaryColorKinRoss text-white w-36 border-b border-black border-r">
                    Elaborado/Aprobado
                  ...
                  <div className="mx-auto">
                    {`${dataAux.emisor.displayName[0].toUpperCase()}.${
                      dataAux.emisor.displayName.split(" ")[1]
                    } / ${dataAux.validadoPor.displayName[0].toUpperCase()}.${
                      dataAux.validadoPor.displayName.split(" ")[1]
                    }`}
                  </div>
                </div>
                <div className="flex">
          ...
          <table className="w-full mt-3" style={{ fontSize: "9pt" }}>
            <thead>
              <tr className="">
                ...
                <th className="border w-2/12">
                  {" "}
                  {dataAux.encabezado.kilometraje}{" "}
                </th>
              </tr>
            </thead>
            <tbody>
              <tr className="">
                ...
                <th className="border w-2/12">
                  {" "}
                  {dataAux.encabezado.areaTrabajo}{" "}
                </th>
                <th className="border border-black w-2/12 bg-primaryColorKinRoss text-white">
                  FECHA
                </th>
                <th className="border w-2/12"> {dataAux.fechaCreacion} </th>
                <th className="border border-black w-2/12 bg-primaryColorKinRoss text-white">
                  PATENTE
                </th>
                <th className="border w-2/12">
                  {" "}
                  {dataAux.encabezado.vehiculo.patente}{" "}
                </th>
              </tr>
            </tbody>
          </table>
